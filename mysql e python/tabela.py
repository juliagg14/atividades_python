...
if cursorx.is_connected():
    ...
    cursor.execute("create table if not exists `dados`(`id` int not null auto_increment primary key, `nome` varchar(50), `idade` int not null);")
    
def adicionar_dados():
    adicionar_dados = f"INSERT INTO `dados`(id, nome, idade) VALUES (%s, %s, %s)"
